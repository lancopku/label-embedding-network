...
parser.add_argument('-src_length', type=int, default=50,
                    help="Maximum source sequence length")
parser.add_argument('-tgt_length', type=int, default=50,
...
parser.add_argument('-char', action='store_true', help='replace unk with char')
